...
SeedMutation.add(<AgriCraft:seedAiry-Infusia>, <AgriCraft:seedRedstodendron>, <AgriCraft:seedBotaniaYellow>);
SeedMutation.add(<AgriCraft:seedFiery-Infusia>, <AgriCraft:seedRedstodendron>, <AgriCraft:seedBotaniaRed>);
SeedMutation.add(<AgriCraft:seedWatery-Infusia>, <AgriCraft:seedRedstodendron>, <AgriCraft:seedBotaniaBlue>);
SeedMutation.add(<AgriCraft:seedTerran-Infusia>, <AgriCraft:seedRedstodendron>, <AgriCraft:seedBotaniaGreen>);
SeedMutation.add(<AgriCraft:seedOrderly-Infusia>, <AgriCraft:seedRedstodendron>, <AgriCraft:seedBotaniaLightGray>);
SeedMutation.add(<AgriCraft:seedEntropic-Infusia>, <AgriCraft:seedRedstodendron>, <AgriCraft:seedBotaniaGray>);
